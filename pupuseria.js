const restauranteNumero = '50375415287';
        ...
        botonesAnadir.forEach(boton => {
            boton.addEventListener('click', () => {
                ...
                if (cantidad > 0) {
                    ...
                    // Reiniciar el campo de cantidad a 1 después de añadir el producto
                    if (targetId) {
                        const cantidadInput = document.getElementById(targetId);
                        if (cantidadInput) {
                            cantidadInput.value = '1'; // Aquí se hizo el cambio de '0' a '1'
                        }
                    }
                }
            });
        ...
        botonConfirmar.addEventListener('click', () => {
           ...
           const espec = acompanamientoSeleccionado || especificacionAdicional;
            if (espec) {
                // CORREGIDO: Usar splice(1, 0, ...) para insertar un elemento sin borrar nada
                mensaje += `\n\nMasa: ${espec}\n`;
            }
